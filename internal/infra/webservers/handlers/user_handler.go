...
func NewUserHanbler(userDb database.UserInterface, jwt *jwtauth.JWTAuth,
	jwtExperiesIn int) *UserHandler {
	return &UserHandler{
		UserDB:        userDb,
		Jwt:           jwt,
...
func (h *UserHandler) GetJWT(w http.ResponseWriter, r *http.Request) {
	...
	accessToken := dto.GetJWTOutput{AccsessToken: tokenString}
